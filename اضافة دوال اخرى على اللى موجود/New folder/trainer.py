        ...
        for idx_data, d in enumerate(self.loader_test):
            for idx_scale, scale in enumerate(self.scale):
                ...
                if self.args.load in ('.', ''):
                    xlsx_path = f'D:/Mohamed Morsi PhD- P2/Ph.D Server/Ph.D/Image Processing/DHTCUN-main/src - Proposed/experiment/{self.args.save}/results-{d.dataset.name}/{d.dataset.name}.xlsx'
                else:
                    xlsx_path = f'D:/Mohamed Morsi PhD- P2/Ph.D Server/Ph.D/Image Processing/DHTCUN-main/src - Proposed/experiment/{self.args.load}/results-{d.dataset.name}/{d.dataset.name}.xlsx'
