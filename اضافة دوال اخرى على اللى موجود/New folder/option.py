...
parser.add_argument('--decay_type', default='step', type=str,
                    help='type of learning rate decay: step, cosine, cosine_restart')
parser.add_argument('--lr_min', default=1e-6, type=float,
                    help='minimum learning rate for cosine annealing')
parser.add_argument('--T0', default=10, type=int,
                    help='first restart period for cosine_restart')
parser.add_argument('--Tmult', default=2, type=int,
                    help='multiplier for restart periods')
...
# Data Augmentation (overrides --no_augment)
parser.add_argument('--augment', action='store_true', default=True,
                    help='use data augmentation (flip + rotation) during training')
